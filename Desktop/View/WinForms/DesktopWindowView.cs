...
namespace ClearCanvas.Desktop.View.WinForms
{
    ...
    public class DesktopWindowView : DesktopObjectView, IDesktopWindowView
    {
		...
		private void LoadWindowSettings()
		{
            ...
            int number = Global.Data.GlobalData.ScreenNumber;
            if (number == 1)
            //if (Global.Data.GlobalData.MonitorNum1 == Global.Data.GlobalData.MonitorNum2)
            {
                //this.SetBounds(0, 0, sc[0].Bounds.Width, sc[0].Bounds.Height);
                int x = sc[Global.Data.GlobalData.MonitorNum1].Bounds.X;
                int y = sc[Global.Data.GlobalData.MonitorNum1].Bounds.Y;
                _form.StartPosition = FormStartPosition.Manual;
                _form.SetBounds(x, y, sc[Global.Data.GlobalData.MonitorNum1].Bounds.Width, sc[Global.Data.GlobalData.MonitorNum1].Bounds.Height);
            }
            else if (number == 2)
            {
                int x = sc[Global.Data.GlobalData.MonitorNum1].Bounds.X;
                int y = sc[Global.Data.GlobalData.MonitorNum1].Bounds.Y;
                int wide = sc[Global.Data.GlobalData.MonitorNum1].Bounds.Width * 2;
                int height = sc[Global.Data.GlobalData.MonitorNum1].Bounds.Height;
                _form.StartPosition = FormStartPosition.Manual;
                _form.SetBounds(x, y, wide, height);
            }
		}
