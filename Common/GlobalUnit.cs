...
namespace Global.Data
{
    ...
    public static class GlobalData
    {
        ...
        [DllImport("WomsoftDecr.dll")]
        public static extern StringBuilder EncrypStr(StringBuilder AA);
        [DllImport("WomsoftDecr.dll")]
        public static extern StringBuilder UncrypStr(StringBuilder AA);
        ...
        public static void ReadIniFile()
        {
            try
            {
                ...
                int boolvalue = inifile.ReadInteger("DataBase", "encrypt", 0);
                if (boolvalue == 1)
                {
                    DBParams.DBUser = UncrypStr(new StringBuilder(DBParams.DBUser)).ToString();
                    DBParams.DBPwd = UncrypStr(new StringBuilder(DBParams.DBPwd)).ToString();
                }
                ...
                UsbKey = efilmini.ReadString("System", "KEY", "");
    ...
    public class Conn
    {
        ...
        public Conn()
        {
            if (GlobalData.DBParams.DBType == "oracle" || GlobalData.DBParams.DBType == "ORACLE")
            {
                ...
                ServerStr = "Data Source=(DESCRIPTION = (ADDRESS_LIST = (ADDRESS = (PROTOCOL = TCP)(HOST=" + server + ")(PORT=1521)))(CONNECT_DATA=(SERVICE_NAME=" + database + ")));User Id=" + uid + ";Password=" + pwd;
